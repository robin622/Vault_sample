...
(function($, window, document) {
	     ...
	     *           node:nPaging - the DIV which contains this pagination control
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				$(nFirst).click( function () {
					...
					{
						fnCallbackDraw( oSettings );
						console.info("fnCallbackDraw"+ "---first");
					}
				} );
				...
				$(nLast).click( function() {
					...
					{
						fnCallbackDraw( oSettings );
						console.info("fnCallbackDraw"+ "---last");
					}
				} );
	...
	$.fn.dataTable = function( oInit )
	{
		...
		{
			console.info("_fnExternApiFunc invoke...");
			return function() {
		...
		{
			console.info("_fnInitalise invoke...");
			var i, iLen;
		...
		{
			console.info("_fnLanguageProcess invoke...");
		...
		{
			console.info("_fnColumnOptions invoke...");
			var oCol = oSettings.aoColumns[ iCol ];
		...
		{
			console.info("_fnAddData invoke...");
		...
		{
			console.info("_fnGatherData invoke...");
		...
		{
			console.info("_fnDrawHead invoke...");
		...
		function _fnDraw( oSettings )
		{
			...
			if ( oSettings.nTBody )
			{
				...
				if ( nBodyPar !== null )
				{
					...
					//do modification immediately
					//console.info('fnDraw invoke..................');
				}
			}
		...
		{
			console.info("_fnAjaxUpdateDraw invoke..");
		...
		{
			console.info("_fnFeatureHtmlTable");
		...
		{
			console.info("_fnFilterComplete invoke");
		...
		{
			console.info("_fnFeatureHtmlPaginate invoke...");
			if ( oSettings.oScroll.bInfinite )
			{
				return null;
			}
		...
		{
			console.info("_fnFeatureHtmlLength invoke...");
			if ( oSettings.oScroll.bInfinite )
			{
				return null;
			}
