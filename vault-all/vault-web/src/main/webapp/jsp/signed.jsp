...
<tbody>
    ...
    <tr>        
    <td><a href=${pageContext.request.contextPath}/showRequest/${signedOffRequest.requestid} title="View Request">${signedOffRequest.requestid}</a></td>
    <td class="wordwrap"><a href=${pageContext.request.contextPath}/showRequest/${signedOffRequest.requestid} title="View Request">${signedOffRequest.requestname}</a></td>
